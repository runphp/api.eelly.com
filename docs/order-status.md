...
25        | **12**(25) | 客服介入完成(钱给买家)  |交易完成      | 客服介入处理完毕 | 无 | 无               | `review`                                           | `待评价`                              
26        | **12**(25) | 客服介入完成(钱给卖家)   |交易完成      | 客服介入处理完毕 | 无 | 无               | `review`                                           | `待评价`                              
27        |**12**(25)  | 客服介入完成(退一部分)   |交易完成      | 客服介入处理完毕 | 无 | 无               | `review` | `待评价` 
28        |**12**(25)  | 客服介入完成(财务处理) |交易完成      | 客服介入处理完毕 | 其他具体原因 | 无               | `review` | `待评价` 
29 | **12**(25) | 退货退款交易完成(无平台介入) |交易完成 | 交易完成 | 无 | 无 | `review` | `待评价` 
